package util; /******************************************************************************
 *  Compilation:  javac utils.StdDraw.java
 *  Execution:    java utils.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code utils.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code utils.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">utils.StdDraw.java</a>
 ...
 *           utils.StdDraw.setPenRadius(0.05);
 *           utils.StdDraw.setPenColor(utils.StdDraw.BLUE);
 *           utils.StdDraw.point(0.5, 0.5);
 *           utils.StdDraw.setPenColor(utils.StdDraw.MAGENTA);
 *           utils.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code utils.StdDraw.line()} and {@code utils.StdDraw.point()}
 *  draw lines and points; the methods {@code utils.StdDraw.setPenRadius()}
 *  and {@code utils.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code utils.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   utils.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code utils.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code utils.StdDraw.setPenColor(utils.StdDraw.MAGENTA)} sets the
 *  pen color to magenta.
 *  <p>
 *  <b>game.Canvas size.</b>
 ...
 *  For example, {@code utils.StdDraw.setCanvasSize(800, 800)}
 *  sets the canvas size to be 800-by-800 pixels.
 *  <p>
 *  <b>game.Canvas scale and coordinate system.</b>
 ...
 *  leave a small margin, you can call {@code utils.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   utils.StdDraw.setFont(font);
 *   utils.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code utils.StdDraw.clear(utils.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   utils.StdDraw.setScale(-2, +2);
 *   utils.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       utils.StdDraw.clear();
 *       utils.StdDraw.filledCircle(x, y, 0.05);
 *       utils.StdDraw.filledCircle(-x, -y, 0.05);
 *       utils.StdDraw.show();
 *       utils.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
 ...
 *  not yet processed).
 *  The second method returns the move key that the user typed (that your program has
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // show we draw immediately or wait until move show?
    ...
    ***************************************************************************/
     ...
     * {@code utils.StdDraw.BLACK}, {@code utils.StdDraw.BLUE}, {@code utils.StdDraw.CYAN},
     * {@code utils.StdDraw.DARK_GRAY}, {@code utils.StdDraw.GRAY}, {@code utils.StdDraw.GREEN},
     * {@code utils.StdDraw.LIGHT_GRAY}, {@code utils.StdDraw.MAGENTA}, {@code utils.StdDraw.ORANGE},
     * {@code utils.StdDraw.PINK}, {@code utils.StdDraw.RED}, {@code utils.StdDraw.WHITE}, and
     * {@code utils.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to utils.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to utils.StdDraw)
        try {
            URL url = utils.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
...
*/
    ...
    ***************************************************************************/
     ...
     * and {@code square()} will be deferred until the move call
    ...
    ***************************************************************************/
    ...
    /**
     * Returns the move key that was typed by the user (that your program has not already processed).
     * This method should be preceded by a call to {@link #hasNextKeyTyped()} to ensure
     * that there is a move key to process.
     * This method returns a Unicode character corresponding to the key
     * typed (such as {@code 'a'} or {@code 'A'}).
     * It cannot identify action keys (such as F1 and arrow keys)
     * or modifier keys (such as control).
     *
     * @return the move key typed by the user (that your program has not already processed).
